...
The reason this code produces an error is that each of these `map_whatever()` functions will specifically try to return a vector in the appropriate format. If this is new to you, then [R4DS is a great place to start](https://r4ds.had.co.nz/vectors.html), but in summary:
