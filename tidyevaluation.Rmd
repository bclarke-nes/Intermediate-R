...
library("pacman")
p_load(purrr, tidyr, ggplot2,dplyr,lubridate, stringr,NHSRdatasets, rlang, glue)
...
We're using a little helper function here, `display()`. You can find the code for this in the source - but really it just saves having to write `head() %>% knitr::kable()` every time we want to look at our data.
