...
## current status
- draft needed on quasiquotation 
- working on / thinking about exercises
...
**`:=`** lets you inject variables into your output. For example, to ensure that a new summary column matches a supplied column name:
...
The column name is then injected using the `:=` operator. This can be applied across a range of dplyr functions:
